  ...
  return (
    <div className="bg-zinc-50 dark:bg-zinc-950 p-4 pb-8">
      <div className="max-w-md mx-auto space-y-4">
              ...
              {myRegistrations.map((reg) => (
                <div key={reg.id} className="p-4 bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-xl border border-blue-100 dark:border-blue-900/30">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-black text-blue-900 dark:text-blue-100 text-lg">{reg.union_programs?.name}</p>
        ...
        <h3 className="font-bold text-zinc-700 dark:text-zinc-300">Program Berlangsung</h3>
        {loading ? (
          <div className="flex justify-center p-8"><Loader2 className="w-8 h-8 animate-spin text-blue-500" /></div>
        ) : programs.length === 0 ? (
          <div className="text-center py-8 bg-white dark:bg-zinc-900 rounded-2xl">
            ...
            {programs.map((program) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-4">
                    {isRegistered ? (
                      <button disabled className="w-full py-2.5 bg-green-500 text-white rounded-xl font-bold flex items-center justify-center gap-2 opacity-80 cursor-not-allowed">
      ...
      {activeFormProgram && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-zinc-900 rounded-2xl w-full max-w-md p-6 max-h-[90vh] overflow-y-auto shadow-2xl">
