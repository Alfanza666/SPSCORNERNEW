    ...
    <div className="pb-8">
      <div className="max-w-md mx-auto px-4 pt-4 space-y-5">
        <motion.div
          ...
          className="bg-gradient-to-br from-red-500 via-rose-600 to-red-600 rounded-3xl p-5 shadow-xl shadow-red-500/20"
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h2 className="text-lg font-black text-white">Buat Laporan</h2>
              <p className="text-sm text-white/80">Pengaduan & Pembelaan Pekerja</p>
            </div>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3">
            <p className="text-xs text-white/90 leading-relaxed">
              Laporan Anda akan dienkripsi dan hanya dapat diakses oleh tim inti SP. Identitas Anda dapat dirahasiakan.
            </p>
          </div>
        </motion.div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-xs font-bold text-zinc-500 dark:text-zinc-400 mb-3 uppercase tracking-wider">Jenis Laporan</label>
            ...
            <div>
              <label className="block text-xs font-bold text-zinc-500 dark:text-zinc-400 mb-2 uppercase tracking-wider">Judul Laporan</label>
              <input
                type="text"
                value={formData.title}
                onChange={(e) => setFormData({ ...formData, title: e.target.value })}
                className="w-full p-4 rounded-2xl border-2 border-zinc-200 dark:border-zinc-700 dark:bg-zinc-800 text-sm focus:border-red-400 focus:ring-0 outline-none transition-all"
            ...
            <div>
              <label className="block text-xs font-bold text-zinc-500 dark:text-zinc-400 mb-2 uppercase tracking-wider">Detail Kronologi</label>
              <textarea
                value={formData.description}
                onChange={(e) => setFormData({ ...formData, description: e.target.value })}
                className="w-full p-4 rounded-2xl border-2 border-zinc-200 dark:border-zinc-700 dark:bg-zinc-800 text-sm focus:border-red-400 focus:ring-0 outline-none h-36 resize-none transition-all"
        ...
        >
          ...
          {loading ? (
            ...
            <div className="text-center py-8 bg-zinc-50 dark:bg-zinc-800/50 rounded-2xl">
              ...
              <p className="text-xs text-zinc-400 mt-1">Kirim laporan pertama Anda sekarang</p>
            </div>
          ) : (
