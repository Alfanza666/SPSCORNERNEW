                  ...
                  >
                    <div className="bg-zinc-50 p-6 rounded-2xl border border-zinc-100 space-y-3 shadow-[inset_1px_1px_2px_rgba(0,0,0,0.05)]">
                      ...
                      <div className="pt-3 border-t border-zinc-200 flex justify-between items-end">
                        ...
                        <span className="text-xl font-black text-blue-600 tracking-tight">{formatRupiah(netPreview)}</span>
                      </div>
                    </div>
                  </motion.div>
                )}
                ...
                <tbody className="divide-y divide-zinc-100">
                  {withdrawals.map((w) => (
                    <tr key={w.id} className="hover:bg-zinc-50/50 transition-colors group">
                      ...
                      <td className="p-6">
                        <p className="font-black text-blue-600">{formatRupiah(w.net_amount)}</p>
                      </td>
                      <td className="p-6">
                        {w.status === 'pending' && (
