...
export default function PWAInstallPrompt() {
  ...
  useEffect(() => {
    ...
    if (isFirefox && isAndroid && !isStandalone) {
        ...
        <div className="bg-blue-600 text-white rounded-2xl shadow-xl p-4 flex items-center justify-between gap-4 border border-blue-500">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {isFirefoxAndroid ? (
                <p className="text-[10px] text-blue-100 font-medium leading-relaxed mt-0.5">
                  Di Firefox: Ketuk menu titik tiga (⋮) di atas lalu pilih <strong className="text-white">"Install"</strong> atau <strong className="text-white">"Add to Home screen"</strong>
                </p>
              ) : (
